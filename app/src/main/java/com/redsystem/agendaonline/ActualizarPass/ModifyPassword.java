...
import com.redsystem.agendaonline.Login_Activity;
...
public class ModifyPassword extends AppCompatActivity {
        ...
        BtnActualizarPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Pass_Actual.equals("")){
                    ...
                    Toast.makeText(ModifyPassword.this, "Las contraseñas no coinciden", Toast.LENGTH_SHORT).show();
                }
    ...
    private void Actualizar_Password(String pass_actual, String nuevo_pass) {
        ...
        user.reauthenticate(authCredential)
                                    ...
                                    public void onSuccess(Void unused) {
                                        ...
                                        BD_Usuarios.child(user.getUid()).updateChildren(hashMap)
                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    @Override
                                                    public void onSuccess(Void unused) {
                                                        Toast.makeText(ModifyPassword.this, "Contraseña cambiada con éxito", Toast.LENGTH_SHORT).show();
                                                        firebaseAuth.signOut();
                                                        Intent intent = new Intent(ModifyPassword.this, Login_Activity.class)
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                progressDialog.dismiss();
                                                Toast.makeText(ModifyPassword.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(ModifyPassword.this, "La contraseña actual no es la correcta", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void InicializarVariables(){
        ...
        progressDialog = new ProgressDialog(ModifyPassword.this);
