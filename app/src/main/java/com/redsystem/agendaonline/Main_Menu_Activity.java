...
import com.redsystem.agendaonline.Configuracion.Configuration_Activity;
import com.redsystem.agendaonline.Notas.Add_Nota;
import com.redsystem.agendaonline.Contactos.Contactos_List;
import com.redsystem.agendaonline.Notas.Notas_List;
import com.redsystem.agendaonline.Notas.Notas_Importantes_List;
import com.redsystem.agendaonline.Perfil.User_Profile;

public class Main_Menu_Activity extends AppCompatActivity {

    View AgregarNotas, ListarNotas, Importantes,Contactos,AcercaDe,CerrarSesion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AgregarNotas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Main_Menu_Activity.this, Add_Nota.class);
        ...
        ListarNotas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Main_Menu_Activity.this, Notas_List.class));
                Toast.makeText(Main_Menu_Activity.this, "Listar Notas", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        Importantes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Main_Menu_Activity.this, Notas_Importantes_List.class));
                Toast.makeText(Main_Menu_Activity.this, "Notas Archivadas", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        Contactos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String uid_usuario = UidPrincipal.getText().toString();
                Intent intent = new Intent(Main_Menu_Activity.this, Contactos_List.class);
    ...
    private void VerificarCuentaCorreo() {
        ...
        builder.setTitle("verificar cuenta")
                ...
                .setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(Main_Menu_Activity.this, "Cancelado por el usuario", Toast.LENGTH_SHORT).show();
                    }
                }).show();
    }
        ...
        user.sendEmailVerification()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(Main_Menu_Activity.this, "Instrucciones enviadas, revise su bandeja " +user.getEmail(), Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //Falló el envío
                        Toast.makeText(Main_Menu_Activity.this, "Falló debido a: "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.Perfil_usuario){
            startActivity(new Intent(Main_Menu_Activity.this, User_Profile.class));
        }
        if (item.getItemId() == R.id.Configuracion){
            String uid_usuario = UidPrincipal.getText().toString();

            Intent intent = new Intent(Main_Menu_Activity.this, Configuration_Activity.class);
            intent.putExtra("Uid", uid_usuario);
            startActivity(intent);
        }
