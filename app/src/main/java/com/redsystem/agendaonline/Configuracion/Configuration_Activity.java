...
public class Configuration_Activity extends AppCompatActivity {
    ...
    private void InicializarVariables(){
        ...
        dialog_autenticacion = new Dialog(Configuration_Activity.this);
    }
                ...
                user.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            EliminarUsuarioBD();
                            Intent intent = new Intent(Configuration_Activity.this, MainActivity.class)
                                    .addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK)
                                    .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            startActivity(intent);
                            finish();
                            Toast.makeText(Configuration_Activity.this, "Se ha eliminado su cuenta con éxito", Toast.LENGTH_SHORT).show();
                        }else {
                            Toast.makeText(Configuration_Activity.this, "Ha ocurrido un problema", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void EliminarUsuarioBD(){
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(Configuration_Activity.this, "Se ha eliminado su cuenta", Toast.LENGTH_SHORT).show();
            }
