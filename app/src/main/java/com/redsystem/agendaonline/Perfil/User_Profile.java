...
import com.redsystem.agendaonline.ActualizarPass.ModifyPassword;
import com.redsystem.agendaonline.Main_Menu_Activity;
...
public class User_Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Editar_imagen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(User_Profile.this, Edit_Profile_Pic.class));
            }
        });
    ...
    private void InicializarVariables(){
        ...
        dialog_establecer_telefono = new Dialog(User_Profile.this);
        ...
        Usuarios.child(user.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    Toast.makeText(User_Profile.this, "Esperando datos", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        Btn_Aceptar_Telefono.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!telefono.equals("")){
                    ...
                    Toast.makeText(User_Profile.this, "Ingrese un número telefónico", Toast.LENGTH_SHORT).show();
                    dialog_establecer_telefono.dismiss();
                }
            }
        });
    ...
    private void Abrir_Calendario(){
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(User_Profile.this, new DatePickerDialog.OnDateSetListener() {
            @Override
        ...
        Usuarios.child(user.getUid()).updateChildren(Datos_Actualizar)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(User_Profile.this, "Actualizado correctamente", Toast.LENGTH_SHORT).show();
                    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.Actualizar_pass){
            startActivity(new Intent(User_Profile.this, ModifyPassword.class));
        }
    ...
    private void ComprobarInicioSesion(){
        if (user!=null){
            ...
            startActivity(new Intent(User_Profile.this, Main_Menu_Activity.class));
            finish();
        }
    }
