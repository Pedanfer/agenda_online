...
public class Edit_Profile_Pic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog_elegir_imagen = new Dialog(Edit_Profile_Pic.this);
        ...
        progressDialog = new ProgressDialog(Edit_Profile_Pic.this);
        ...
        databaseReference.child(user.getUid())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(Edit_Profile_Pic.this, "Imagen se ha actualizado con éxito", Toast.LENGTH_SHORT).show();
                        onBackPressed();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
