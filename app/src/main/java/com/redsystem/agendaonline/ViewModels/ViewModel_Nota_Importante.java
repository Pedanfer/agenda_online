...
public class ViewModel_Nota_Importante extends RecyclerView.ViewHolder {

    View mView;

    private ViewModel_Nota_Importante.ClickListener mClickListener;
    ...
    public void setOnClickListener(ViewModel_Nota_Importante.ClickListener clickListener){
        mClickListener = clickListener;
    }

    public ViewModel_Nota_Importante(@NonNull View itemView) {
        super(itemView);
        mView = itemView;
