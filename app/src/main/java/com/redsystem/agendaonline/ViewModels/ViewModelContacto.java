...
public class ViewModelContacto extends RecyclerView.ViewHolder {

    View mView;

    private ViewModelContacto.ClickListener mClickListener;
    ...
    public void setOnClickListener(ViewModelContacto.ClickListener clickListener){
        mClickListener = clickListener;
    }

    public ViewModelContacto(@NonNull View itemView) {
        super(itemView);
        mView = itemView;
