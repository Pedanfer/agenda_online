...
public class ViewModel_Nota extends RecyclerView.ViewHolder {

    View mView;

    private ViewModel_Nota.ClickListener mClickListener;
    ...
    public void setOnClickListener(ViewModel_Nota.ClickListener clickListener){
        mClickListener = clickListener;
    }

    public ViewModel_Nota(@NonNull View itemView) {
        super(itemView);
        mView = itemView;
