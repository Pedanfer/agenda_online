...
public class Modify_Contacto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(Modify_Contacto.this);
    ...
    private void InicializarVistas(){
        ...
        dialog_establecer_telefono = new Dialog(Modify_Contacto.this);
        ...
        Btn_Aceptar_Telefono.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!telefono.equals("")){
                    ...
                    Toast.makeText(Modify_Contacto.this, "Ingrese un número telefónico", Toast.LENGTH_SHORT).show();
                    dialog_establecer_telefono.dismiss();
                }
            }
        });
    ...
    private void ActualizarInformacionContacto(){
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(Modify_Contacto.this, "Información actualizada", Toast.LENGTH_SHORT).show();
            }
    ...
    private void subirImagenStorage(){
        ...
        reference.putFile(imagenUri)
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Modify_Contacto.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        databaseReference.child(user.getUid()).child("Contactos").child(id_c)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(Modify_Contacto.this, "Imagen actualizada con éxito", Toast.LENGTH_SHORT).show();
                        onBackPressed();
                    }
                }).addOnFailureListener(new OnFailureListener() {
            @Override
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        Toast.makeText(Modify_Contacto.this, "Cancelado por el usuario", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
