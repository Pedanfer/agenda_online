...
public class Detail_Contacto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Llamar_C.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(Detail_Contacto.this,
    ...
    private void ObtenerImagen(){
        ...
        try {
            ...
            Glide.with(getApplicationContext()).load(imagen).placeholder(R.drawable.baseline_person_white).into(Imagen_C_D);
