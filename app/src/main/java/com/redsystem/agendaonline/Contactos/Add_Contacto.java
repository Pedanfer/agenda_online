...
public class Add_Contacto extends AppCompatActivity {
    ...
    private void InicializarVariables(){
        ...
        dialog_establecer_telefono = new Dialog(Add_Contacto.this);
        BD_Usuarios = FirebaseDatabase.getInstance().getReference("Usuarios");

        firebaseAuth = FirebaseAuth.getInstance();
        user = firebaseAuth.getCurrentUser();

        dialog = new Dialog(Add_Contacto.this);
    }
        ...
        Btn_Aceptar_Telefono.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!telefono.equals("")){
                    ...
                    Toast.makeText(Add_Contacto.this, "Ingrese un número telefónico", Toast.LENGTH_SHORT).show();
                    dialog_establecer_telefono.dismiss();
                }
            }
        });
