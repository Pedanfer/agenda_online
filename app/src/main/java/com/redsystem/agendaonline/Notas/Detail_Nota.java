...
public class Detail_Nota extends AppCompatActivity {
    ...
    private void Agregar_Notas_Importantes(){
        if (user == null){
            ...
            Toast.makeText(Detail_Nota.this, "Ha ocurrido un error", Toast.LENGTH_SHORT).show();
        }else {
            ...
            reference.child(firebaseAuth.getUid()).child("Mis notas importantes").child(id_nota_R)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Toast.makeText(Detail_Nota.this, "Se ha añadido a notas importantes", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Detail_Nota.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
        ...
        if (user == null){
            ...
            reference.child(firebaseAuth.getUid()).child("Mis notas importantes").child(id_nota_R)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void unused) {
                            Toast.makeText(Detail_Nota.this, "La nota ya no es importante", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
