...
public class Modify_Nota extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void SeleccionarFecha(){
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(Modify_Nota.this, new DatePickerDialog.OnDateSetListener() {
            @Override
    ...
    private void ActualizarNotaBD(){
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(Modify_Nota.this, "Nota actualizada con éxito", Toast.LENGTH_SHORT).show();
                onBackPressed();
