...
import com.redsystem.agendaonline.ViewModels.ViewModel_Nota_Importante;
import org.jetbrains.annotations.NotNull;

public class Notas_Importantes_List extends AppCompatActivity {
    ...
    FirebaseRecyclerAdapter<Nota , ViewModel_Nota_Importante> firebaseRecyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new Dialog(Notas_Importantes_List.this);
    ...
    private void ComprobarUsuario(){
        if (user == null){
            Toast.makeText(Notas_Importantes_List.this, "Ha ocurrido un error", Toast.LENGTH_SHORT).show();
        }else {
    ...
    private void ListarNotasImportantes() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Nota, ViewModel_Nota_Importante>(firebaseRecyclerOptions) {
            @Override
            protected void onBindViewHolder(@NonNull ViewModel_Nota_Importante viewModel_nota_importante, int position, @NotNull Nota nota) {
                viewModel_nota_importante.SetearDatos(
            ...
            @Override
            public ViewModel_Nota_Importante onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_nota_importante,parent,false);
                ViewModel_Nota_Importante viewModel_nota_importante = new ViewModel_Nota_Importante(view);
                viewModel_nota_importante.setOnClickListener(new ViewModel_Nota_Importante.ClickListener() {
                    @Override
                    ...
                    public void onItemLongClick(View view, int position) {
                        ...
                        EliminarNotaCancelar.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Toast.makeText(Notas_Importantes_List.this, "Cancelado por el usuario", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }
                        });
                ...
                return viewModel_nota_importante;
            }
        };

        linearLayoutManager = new LinearLayoutManager(Notas_Importantes_List.this, LinearLayoutManager.VERTICAL, false);
            ...
            reference.child(firebaseAuth.getUid()).child("Mis notas importantes").child(id_nota)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Toast.makeText(Notas_Importantes_List.this, "La nota ya no es importante", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Notas_Importantes_List.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
